        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> View officer</h3> </div>
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add_teacher.php"><button class="btn btn-primary">Add Officer</button></a>
                          <?php } } ?>
            ...
            <?php if(isset($useroles)){  if(in_array("edit_teacher",$useroles)){ ?> 
                                                <a href="edit_teacher.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-plus-square"></i>Edit</button></a>
                                              <?php } } ?>
